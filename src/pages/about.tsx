  ...
  return (
    <section className="w-full md:w-8/12 mx-auto space-y-20 px-4 md:px-0">
      <div className="max-w-2xl">
        <h3 className="mt-3 text-gray-800 text-3xl font-extrabold sm:text-4xl">Get to know about us</h3>
        <div className="mt-3 text-gray-600 dark:text-gray-400">
          <p>
            We are a team of professionals who are dedicated to providing the best education consultancy services in Nepal. We are here to help you make the right decision for your future. If you have any questions, feel free to{" "}
            <Link
            ...
            <ul className="flex-1 space-y-6 sm:last:pb-6 sm:space-y-8">
              {list.qas.map((item: any, idx: number) => (
                <li key={idx}>
                  ...
                  <p className="mt-3 text-gray-600 leading-relaxed">{item.a2}</p>
                  <p className="mt-3 text-gray-600 leading-relaxed">{item.a3}</p>
                </li>
              ))}
            </ul>
          </div>
    ...
    qas: [
      {
        ...
        a2: "We counsel students  by analyzing their academic profile and advising them the best suitable option best matched to their own career aspiration. Currently, PRO-VISA, #1 Education Consultancy in Nepal is recruiting students from Nepal to Australia, USA, UK, China, Japan, Germany, France, Hungary, Finland, India, China, and Bangladesh for higher study and providing different language classes for student which benefits students for easy communication and maintain a bond with different countries.",
