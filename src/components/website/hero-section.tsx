    ...
    <Carousel className="w-full">
      <CarouselContent>
        {banners.map((banner, index) => (
          ...
          >
            <div className="w-full h-full absolute top-0 left-0 bg-primary-600 opacity-50 z-10"></div>
...
const banners = [
  ...
  },
  {
    ...
    description:
      "Our collaborative approach is designed to support you every step of the way. We work closely with you to navigate the complexities of the education and visa process, ensuring a smooth and successful experience.",
    bgimage: "herobanner1",
  },
];
