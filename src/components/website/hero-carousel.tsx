        ...
        {lists.map((item, index) => (
          ...
          >
            <div className="  space-y-2 md:space-y-4 px-4">
              <p className=" text-xs  md:text-2xl font-medium tracking-wider text-primary-500">
                {item.title}
              </p>
              <p className="text-xl md:text-5xl font-bold tracking-wider text-secondary-900">
                {item.h1}
              </p>
              <p
                className={`text-primary-500 text-xl  md:text-6xl font-bold tracking-wider text-opacity-90`}
              >
                {item.h2}
              </p>
